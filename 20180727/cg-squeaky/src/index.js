...
getNextComment = (commentId) => {
	var that = this;
	var fetchData = require('./CommentFunctions.js').fetchData;
	fetchData(require('./api_url.js').getNextCommentsURL+this.appendSelectTag(commentId), this, function(){that.setState({dummy:""})});
};

getPrevComment = (commentId) => {
	var that = this;
	var fetchData = require('./CommentFunctions.js').fetchData;
	fetchData(require('./api_url.js').getPrevCommentsURL+this.appendSelectTag(commentId), this, function(){that.setState({dummy:""})});
};

getLastComments = () => {
	var that = this;
	var fetchData = require('./CommentFunctions.js').fetchData;
	fetchData(require('./api_url.js').getLastCommentsURL+this.appendSelectTag(), this, function(){that.setState({dummy:""})});
};
